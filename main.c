...
int main(int argc, char *argv[]) {
     ...
     * antes do laco principal (em vez de comparar string a cada unidade de tempo) */
    ...
    for (int t = 0; t < tempo_total; t++) {
        ...
        simular_instante(cadastradas, &fila_prontos, t, comparar, lost_deadlines, completas);
    }
